...
const MainScreen = props => {
    ...
    console.log("ooooooooo  " + markers[0].marker + markers[0].name)
    ...
    const getContacts = (contacts) => {
        ...
        contacts.map(contact => {
            ...
            let lonlat = []
            let popup = ""
            lonlat.push(contact.lon, contact.lat)
        ...
        <div id="Main-Screen" className="w3-panel w3-card w3-light-green full-width">
            ...
            <div className="w3-container w3-row w3-section">
                <div className="w3-container w3-col s6">
                    <ContactsList showMy={showMyContacts} id={props.user} contacts={getContacts}/>
                    <div className="w3-container w3-row w3-section">
